...
docker run -d \
  ...
  ghcr.io/lkrcharon/oh-my-sub2api:latest
```
...
services:
  sub2api:
    image: ghcr.io/lkrcharon/oh-my-sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/ghcr.io/lkrcharon/oh-my-sub2api)
- [Documentation](https://github.com/ghcr.io/lkrcharon/oh-my-sub2api#readme)
