...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/LKRCharon/oh-my-sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="LKRCharon/oh-my-sub2api"
...
Documentation=https://github.com/LKRCharon/oh-my-sub2api
