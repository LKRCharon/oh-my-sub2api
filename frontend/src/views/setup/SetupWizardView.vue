  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-dark-800">
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-800/50 dark:bg-primary-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
            ...
            <div>
              ...
              <p class="mt-1 text-sm text-primary-600 dark:text-primary-500">
                {{
                  serviceReady
