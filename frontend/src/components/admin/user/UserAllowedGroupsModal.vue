              ...
              <div class="flex items-center gap-4">
                ...
                <div class="flex-shrink-0">
                  <input
                    ...
                    class="h-5 w-5 cursor-pointer rounded-md border-2 border-primary-400 text-primary-600 focus:ring-primary-500 dark:border-primary-600"
                  />
                  <div
                    v-else
                    class="flex h-5 w-5 items-center justify-center rounded-md border-2 border-primary-400 bg-primary-500 dark:border-primary-600 dark:bg-primary-600"
                  >
