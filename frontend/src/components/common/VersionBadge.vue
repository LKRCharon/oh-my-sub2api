...
const GITHUB_REPO = 'LKRCharon/oh-my-sub2api'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/lkrcharon/oh-my-sub2api:0.1.146)
const DOCKER_IMAGE = 'ghcr.io/lkrcharon/oh-my-sub2api'
